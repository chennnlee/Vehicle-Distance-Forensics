...
| `gen_radar_validation.js` | **單一主題簡報(2026-09-01,17 張):他車距離與速度對車載雷達的驗證** —— 第 2 張先講系統怎麼算出距離(接地點/地面平面/尺度錨/虛線碼表法),第 8 張講五個統計名詞各自回答什麼問題,之後每一頁的數字下方都有一條「怎麼解讀」把該數字換成具體情境。**體例三條:不採「自我更正」框架、不用比喻、名詞與數字都要說用途**(成果報告 4.7/4.10/4.12 的自我更正寫法維持不變,兩者定位不同) |
