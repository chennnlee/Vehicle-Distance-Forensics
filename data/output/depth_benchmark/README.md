...
**方法、全部數字與重現指令在 `docs/DEPTH_MODEL_BENCHMARK.md`(18 節;§18 是 2026-09-17 的更正紀錄)。**
...
$P tools/depth_blind_analysis.py --all --delta-m 2.0   # 五個檢查:methodc / sources / samerow / holdout / transfer
